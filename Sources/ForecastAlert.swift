...
/// The ForecastAlert objects represent the severe weather warnings issued for the requested location by a governmental authority (please see our data sources page for a list of sources).
